...
function sendComment(data) {
    ...
    $.ajax(settings).done(function (response) {
        $('#send-comment').text('Send greetings');
        showAlert('Speech has been received', 'success');
    });
}
...
$('#send-comment').click(function(e){
    ...
    $('.form-control').each(function(idx, value){
        ...
        if (value.value == "" || value.value == null) {
            showAlert(names[1] + ' can not be empty', 'error');
            isValid = false;
            return false;
        }
...
var galleryImages = [
//QUEEN GAMBIT
{'id':'1uvHKY92hEd1u4TuOS_FRfVjfa0s1z8T6', 'name':'1'},
{'id':'1hNxWXSENXP2pbTCAQvnAEPVJLVi53ORL', 'name':'2'},
{'id':'17QbKhCYgXTwO6FFOyl-ShQNY7vzanRnk', 'name':'3'},
{'id':'1QD7KMwxfARVeb-_PqaVj3eUiZplXOcna', 'name':'4'},
{'id':'16qrzSu4tSXoz_lS55PCC-XY5A5zDntJz', 'name':'5'},
{'id':'1nQHnhOgwxiqC9mpich8z_3-Y2BFwk2kD', 'name':'6'},
{'id':'1Xg_KNVPXlBSq16mjBGVs13zUO7E32Ej2', 'name':'7'},
{'id':'1BnicFYYNLQlz4t2bDSoQcZr6HMe4ueny', 'name':'8'},
{'id':'1cbARyfgq7y74xKjH-ROV02OieehtwNpF', 'name':'9'},
{'id':'1RfI8IYcW4J3y-IXKJl2NaIzOxXJ2XUEQ', 'name':'10'},
{'id':'1msxOdduKzeromp2SWl0GZ8v7dmoYNUYM', 'name':'11'},
{'id':'15Vbv0FCaWNa7dVh3gmnk-UpzAsphHXmC', 'name':'12'},
{'id':'1uzY0aCtoJKX_HljVPwn-ZgfxrKR6X666', 'name':'13'},
{'id':'12_6YyKv-skHm2a7-v3topXc5aBpEC9BP', 'name':'14'},
{'id':'1XbQLSwRJ_QTbC4Bzftwskat9ml8xDW_Q', 'name':'15'},
{'id':'1xI5U5XHICMECOjZ6gXsMGpU0DWgSDq76', 'name':'16'},
{'id':'1l4NLEdQ7ncCKMZfDgbRfR782I7zgb4tO', 'name':'17'},
{'id':'1JiFlyAEqDm_mQ5MPlkx2gz1coLMkIxtG', 'name':'18'},
{'id':'1mUK_rSikZyqsDvzbmlAqtH_t-selaLby', 'name':'19'},
{'id':'1GM8MVNa6IfL5zqg-vOAiZc6uTNa3t6rj', 'name':'20'},
{'id':'vMYcyEymYn5E3JYnS1Hag3mah8OoEfJ', 'name':'21'},
{'id':'1xRVi0O3LmH32GMibys4TxctAkDxQNY8X', 'name':'22'},
{'id':'1K2wijEm3rU1-KlEdgk43GDhkFevF5cXs', 'name':'23'},
